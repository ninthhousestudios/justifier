...
// AUTOMATED self-playing bow: slow constant-velocity stroke (triangle LFO).
bowRate = nentry("bow_rate", 0.18, 0.02, 2.0, 0.001);
bowDepth = nentry("bow_depth", 0.4, 0.0, 1.0, 0.001);
tri = 1.0 - 2.0*abs(2.0*os.lf_sawpos(bowRate) - 1.0);
in1 = (tri * bowDepth) : si.smoo;
