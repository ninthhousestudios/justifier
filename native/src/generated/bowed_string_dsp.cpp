 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp43 = fRec5[2] + fRec5[0] + 2.0f * fRec5[1];
			float fTemp44 = fConst8 * fTemp43;
			fRec4[0] = fTemp44 - (fRec4[2] * ((fTemp2 - fTemp1) / fTemp0 + 1.0f) + 2.0f * fRec4[1] * (1.0f - 1.0f / Bowed_stringDSP_faustpower2_f(fTemp0))) / fTemp3;
			float fTemp45 = fRec4[2] + fRec4[0] + 2.0f * fRec4[1];
			float fTemp46 = fTemp0 * fTemp3;
			float fTemp47 = fRec4[0] - fRec4[2];
			fRec32[0] = fSlow15 + fConst2 * fRec32[1];
			output0[i0] = static_cast<FAUSTFLOAT>(fRec32[0] * ((iSlow8) ? ((iSlow14) ? fConst8 * fTemp43 * (1.0f - fTemp47 / fTemp46) : fConst8 * (fTemp43 * fTemp47 / fTemp46)) : ((iSlow9) ? -(fConst8 * fTemp43 * (fTemp45 / fTemp3 - fTemp44)) : fConst8 * (fTemp43 * fTemp45 / fTemp3))) * std::max<float>(0.0f, std::min<float>(fSlow4 * fRec1[0], std::max<float>(fSlow6 * (fSlow3 - fRec1[0]) + 1.0f, fSlow5)) * (1.0f - fSlow2 * static_cast<float>(iRec0[0]))));
			fVec0[1] = fVec0[0];
			iRec0[1] = iRec0[0];
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
