...
Compilation options: -lang cpp -i -fpga-mem-th 4 -ct 1 -cn Lfnoise0DSP -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __Lfnoise0DSP_H__
#define  __Lfnoise0DSP_H__
...
static float Lfnoise0DSP_faustpower2_f(float value) {
	return value * value;
}

class Lfnoise0DSP : public dsp {
 ...
 public:
	...
	Lfnoise0DSP(const Lfnoise0DSP&) = default;
	
	virtual ~Lfnoise0DSP() = default;
	
	Lfnoise0DSP& operator=(const Lfnoise0DSP&) = default;
	
	void metadata(Meta* m) { 
		m->declare("basics.lib/name", "Faust Basic Element Library");
		m->declare("basics.lib/version", "1.22.0");
		m->declare("compile_options", "-lang cpp -i -fpga-mem-th 4 -ct 1 -cn Lfnoise0DSP -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		...
		m->declare("filename", "lfnoise0.dsp");
	...
	virtual Lfnoise0DSP* clone() {
		return new Lfnoise0DSP(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("lfnoise0");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp4 = fSlow13 * fRec8[0];
			float fTemp5 = std::cos(fTemp4);
			float fTemp6 = std::sin(fTemp4);
			fRec6[0] = fRec7[1] * fTemp6 + fRec6[1] * fTemp5;
			fRec7[0] = static_cast<float>(1 - iVec0[1]) + fRec7[1] * fTemp5 - fTemp6 * fRec6[1];
			int iTemp7 = (fRec6[1] <= 0.0f) & (fRec6[0] > 0.0f);
