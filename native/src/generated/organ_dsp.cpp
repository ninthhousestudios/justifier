 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp31 = (fRec4[2] + fRec4[0] + 2.0f * fRec4[1]) / fTemp3;
			float fTemp32 = (fRec4[0] - fRec4[2]) / (fTemp0 * fTemp3);
			fRec33[0] = fSlow23 + fConst2 * fRec33[1];
			output0[i0] = static_cast<FAUSTFLOAT>(fRec33[0] * ((iSlow8) ? ((iSlow22) ? fTemp30 - fTemp32 : fTemp32) : ((iSlow9) ? fTemp30 - fTemp31 : fTemp31)) * std::max<float>(0.0f, std::min<float>(fSlow4 * fRec1[0], std::max<float>(fSlow6 * (fSlow3 - fRec1[0]) + 1.0f, fSlow5)) * (1.0f - fSlow2 * static_cast<float>(iRec0[0]))));
			iVec0[1] = iVec0[0];
			fVec1[1] = fVec1[0];
			iRec0[1] = iRec0[0];
			fRec1[1] = fRec1[0];
